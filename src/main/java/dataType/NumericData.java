...
public class NumericData {
	...
	System.out.println("Total Shopping" + " " + spentTotal);
	
	
	
	 /*
	 * go to shopping with 12000.00 dollar
	 * buy 100pen for 
	 * buy 50book
	 * bring change back
	 * 
	...
	double doll = 12000.00;
	float pen1 = 100;
	double totalPe= pen1*100;
	float book1=50;
	float Totalboo = book1*10;
	double TotalExpe = totalPe+Totalboo;
	System.out.println("totalexpense"+" "+ TotalExpe);
