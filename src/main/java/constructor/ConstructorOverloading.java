...
// constructor without email account
	...
	public static void main(String[] args) {
		...
		belal.comapnayEmployee(215258, 58454);
		
		ConstructorOverloading shirin= new ConstructorOverloading(04, "Shirin", "A", "5555", "SA@gmai");
		shirin.studentFee(400, 50);
	
	}
public void comapnayEmployee (double salary, int fee){
	
	double totalSalary= salary +fee;
	System.out.println("employeeslary is"+" "+totalSalary);
