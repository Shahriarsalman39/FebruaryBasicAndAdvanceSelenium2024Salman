 ...
 *   same method name with Different method signature(perameter)
 ...
 */
   ...
   public String student(int studentTutionFee, int lateFee) {
	  ...
	  System.out.println(totalPayment+" "+ differentPayment );
	   System.out.println("2 int argument student method"+totalPayment);
	return null;
   ...
   public double student (double tuitionFee, int id) {
	   System.out.println("Annual tuition fee");
	return id;
